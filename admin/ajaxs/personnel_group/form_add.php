	...
	<div class="row">
		<div class="col-md-8">
			<div class="form-group">
				...
				<input type="text" id="txt_name" name="txt_name" class="form-control" value="" placeholder="Tên chức vụ của nhà khoa học">
			</div>
			...
			<div class="form-group">
				<label>Mô tả</label>
				<textarea id="intro" class="form-control" name="intro" placeholder="Mô tả về chức vụ" rows="3"></textarea>
			</div>
		</div>
	...
	$(document).ready(function(){
		$("form#frm_action").submit(function(e) {
			if(validForm()){
				...
				var _url="<?php echo ROOTHOST;?>ajaxs/personnel_group/process_add.php";
				$.ajax({
					url: _url,
					type: 'POST',
					data: formData,
