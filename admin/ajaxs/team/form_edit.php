	...
	<div class="row">
		<div class="col-md-8">
			<div class="form-group">
				...
				<input type="text" id="txt_name" name="txt_name" class="form-control" value="<?php echo $row['title'];?>" placeholder="Tên nhóm nghiên cứu viên" required>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="date" id="end_date" name="end_date" value="<?php echo date('Y-m-d', $row['end_date']);?>" class="form-control">
					</div>
				</div>
			</div>
	...
	$(document).ready(function(){
		$("form#frm_action").submit(function(e) {
			if(validForm()){
				...
				var _url="<?php echo ROOTHOST;?>ajaxs/team/process_edit.php";
				$.ajax({
					url: _url,
					type: 'POST',
					data: formData,
		...
		$('#add_personnel').on('click', function(){
			...
			$.post(_url, {'ids': ids}, function(req){
				...
				$('#popup_modal2 .modal-title').html('Danh sách nhà khoa học');
