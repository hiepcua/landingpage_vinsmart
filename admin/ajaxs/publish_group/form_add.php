	...
	<div class="row">
		<div class="col-md-8">
			<div class="form-group">
				...
				<input type="text" id="txt_name" name="txt_name" class="form-control" value="" placeholder="Tiêu đề loại xuất bản">
			</div>
	...
	$(document).ready(function(){
		...
		$("form#frm_action").submit(function(e) {
			if(validForm()){
				...
				var _url="<?php echo ROOTHOST;?>ajaxs/publish_group/process_add.php";
				$.ajax({
					url: _url,
					type: 'POST',
					data: formData,
