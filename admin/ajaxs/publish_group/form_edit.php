		...
		<div class="col-md-8">
			...
			<div class="form-group">
				...
				<div class="input-group mb-3">
					<input type="text" id="publish_group_code" name="publish_group_code" class="form-control" value="<?php echo $row['code'];?>" required>
	...
	$(document).ready(function(){
		...
		$("form#frm_action").submit(function(e) {
			if(validForm()){
				...
				var _url="<?php echo ROOTHOST;?>ajaxs/publish_group/process_edit.php";
				$.ajax({
					url: _url,
					type: 'POST',
					data: formData,
