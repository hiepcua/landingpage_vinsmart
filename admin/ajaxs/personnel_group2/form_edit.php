...
?>
<br/>
<h3 class='text-center'>Cập nhật nhóm nhân viên</h3>
	...
	<div class="row">
		<div class="col-md-8">
			<div class="form-group">
				...
				<input type="text" id="txt_name" name="txt_name" class="form-control" value="<?php echo $row['title'];?>" placeholder="Tên nhóm nhân viên" required>
			</div>
			...
			<div class="form-group">
				<label>Mô tả</label>
				<textarea id="intro" class="form-control" name="intro" placeholder="Mô tả về nhóm nhân viên" rows="3"><?php echo $row['intro'];?></textarea>
			</div>
		</div>
	...
	$(document).ready(function(){
		$("form#frm_action").submit(function(e) {
			if(validForm()){
				...
				var _url="<?php echo ROOTHOST;?>ajaxs/personnel_group2/process_edit.php";
				$.ajax({
					url: _url,
					type: 'POST',
					data: formData,
