...
if(isset($_POST['cmdsave_tab1']) && $_POST['txt_name']!='') {
	...
	$result = SysEdit('tbl_common_knowledge', $arr, " id=".$GetID);
	...
	if($result) {
		...
		// $arr2['image'] = $file;
		// $arr2['meta_title'] = $arr['meta_title'];
		// $arr2['meta_key'] = $arr['meta_title'];
		// $arr2['meta_desc'] = $arr['meta_desc'];
...
$res_Cate = SysGetList('tbl_common_knowledge', array(), ' AND id='. $GetID);
if(count($res_Cate) <= 0){
...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Cập nhật phổ biến kiến thức</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST;?>">Bảng điều khiển</a></li>
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST.COMS;?>">Danh sách phổ biến kiến thức</a></li>
					<li class="breadcrumb-item active">Cập nhật phổ biến kiến thức</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
					...
					<div class="row">
						<div class="col-md-8 col-lg-9">
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="place" placeholder="Địa điểm diễn ra..." rows="1"><?php echo $row['place'];?></textarea>
							</div>

							<div class="form-group">
								<label>Báo cáo viên</label>
								<textarea class="form-control" name="rapporteur" placeholder="Báo cáo viên..." rows="1"><?php echo $row['rapporteur'];?></textarea>
							</div>

							<div class="form-group">
								<label>Mô tả</label>
								<textarea class="form-control" name="intro" id="intro"><?php echo $row['intro'];?></textarea>
							</div>
						...
						<div class="col-md-4 col-lg-3">
							<div class="form-group">
								...
								<select class="form-control" name="language" id="language">
									<option value="vn" <?php echo $row['language']=='vn' ? 'selected':'';?>>Tiếng Việt</option>
									<option value="en" <?php echo $row['language']=='en' ? 'selected':'';?>>Tiếng Anh</option>
								</select>
							</div>
