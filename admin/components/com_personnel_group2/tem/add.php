...
if(isset($_POST['cmdsave_tab1']) && $_POST['txt_name']!='') {
	...
	$result = SysAdd('tbl_personnel_group2', $arr);
	if($result){
		...
		// SysAdd('tbl_seo', $arr2);
		SysEdit('tbl_personnel_group2', array('path' => $path), " id=".$result);
...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Thêm mới nhóm nhân sự</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST;?>">Bảng điều khiển</a></li>
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST.COMS;?>">Danh sách nhóm nhân sự</a></li>
					<li class="breadcrumb-item active">Thêm mới nhóm nhân sự</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
					...
					<div class="row">
						<div class="col-md-8 col-lg-9">
							<div class="form-group">
								...
								<input type="text" id="txt_name" name="txt_name" class="form-control" value="" placeholder="Tên chức vụ của nhân sự">
							</div>
							...
							<div class="form-group">
								<label>Mô tả</label>
								<textarea class="form-control" name="txt_intro" placeholder="Mô tả về chức vụ của nhân sự..." rows="2"></textarea>
							</div>
...
<script type="text/javascript">
	...
	function validForm(){
		...
		if(code==''){
			alert('Mã chức vụ của nhân sự không được để trống');
			flag = false;
		}
		return flag;
	}
